...
const ForgotPassword = () => {
  ...
  return (
    <Layout title={"Forgot Password - Cartify"}>
      <div className="bg-[#E8E8E8] w-full font-Jost-Regular">
        <div className="container flex justify-center items-center w-full h-[80vh]">
          <form onSubmit={handleSubmit} className="w-[400px] flex flex-col gap-10 px-8 pb-[0.4em] bg-white rounded-lg">
            <p id="heading" className="text-center my-8 text-black text-2xl font-Jost-Medium">Reset Password</p>
            ...
            <div className=" flex items-center justify-center gap-[0.5em] rounded-lg p-[0.6em] border-none outline-none text-white bg-gray-900 shadow-inner">
              ...
              <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} required autoComplete="off" placeholder="What is Favorite Sports ?" className="bg-gray-900 border-none rounded-md outline-none w-full text-gray-500"/>
            </div>
            ...
            <div className=" flex items-center justify-center gap-[0.5em] rounded-lg p-[0.6em] border-none outline-none text-white bg-gray-900 shadow-inner">
              ...
              <input placeholder="New Password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} type={showPassword ? 'text' : 'password'} className="input-field bg-none border-none outline-none w-full bg-gray-900 text-gray-500" />
              <img src={eye} alt="eye" onClick={togglePasswordVisibility} className="cursor-pointer"/> 
            </div>

            <button type="submit" className="w-[200px] flex justify-between mx-auto py-2 px-4 rounded-md transition-all ease-in-out duration-150 bg-gray-800 text-white hover:bg-black mb-10">
              <p className="pl-14">Reset</p>
